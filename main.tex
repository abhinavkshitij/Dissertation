...
\include{Ch8/chapter8}  % New Ch 7
\include{Ch9/chapter9}  % New Ch 8
\include{Ch10/chapter10} % New Ch 9
\include{Ch7/chapter7}  % New Ch 10
...
\phantomsection
\addtocontents{toc}%                    % Add this 'mark' to TOC so subsequent pages use
  {\protect\markboth{CHAPTER}{Page}}%   the bibliography heading (unlikely since 
