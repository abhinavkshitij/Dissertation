...
\usepackage{calc}					              % Calculate text widths; used in page layout 
                                        %   changes
%\usepackage{amsmath}
\usepackage{pdfsync}                    % Sync pdf with Skim 
\synctex=1      
...
\newcommand*\defdate{April 2019}     %<Give month (written out fully) and year of 
                                        %   the oral defense
\listadd{\committeechair}{Werner J.A. Dahm} %<Enter committee chair name; use \listadd for
\newcommand*{\chairlabel}{Chair}        
%\listadd{\committeemember}{Professor Hans D. Mittelmann} 
\listadd{\committeemember}{Marcus Herrmann} 
\listadd{\committeemember}{Yulia T. Peet} 
\listadd{\committeemember}{Peter E. Hamlington} 
\listadd{\committeemember}{Jeonglae Kim} 
...
%%% Depth %%%
\settocdepth{subsubsection}              % Include 5 levels deep (all levels) in TOC
