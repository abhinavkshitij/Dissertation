...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\listadd{\titlelines}%
  {Accurate and Efficient Autonomic Closure for Turbulent Flows}%<Enter the title of the dissertation
%\listadd{\titlelines}%
...
\newcommand*\defdate{April 2019}     %<Give month (written out fully) and year of 
                                        %   the oral defense
\listadd{\committeechair}{Professor Werner J.A. Dahm} %<Enter committee chair name; use \listadd for
\newcommand*{\chairlabel}{Chair}        
%\listadd{\committeemember}{Professor Hans D. Mittelmann} 
\listadd{\committeemember}{Associate Professor Marcus Herrmann} 
\listadd{\committeemember}{Associate Professor Yulia T. Peet} 
\listadd{\committeemember}{Assistant Professor Peter E. Hamlington} 
\listadd{\committeemember}{Assistant Professor Jeonglae Kim} 

\newcommand*{\gradmonth}{April}         %<Enter the graduation date; month can only be: 
...
% ---
% TEMP FIX:
\setlength{\forfootskip}%               % Initially set to 3\baselineskip
  {0\baselineskip}
% ---
...
% ---
% TEMP FIX:                                        
\setheadfoot{1\baselineskip}%           % Set '\headheight' and '\footskip'
   {\forfootskip}                       % Initially set to \setheadfoot{\baselineskip}
                                        % {\forfootskip}
% ----   
...
% ---
% TEMP FIX:
% Fix for printing out hardcopy. Comment out while submitting the softcopy. 
\usepackage{fancyhdr}
...
\setsecheadstyle{\bfseries}         %   will need to set the indent for all lower 
...
% \captionstyle[\centered]%              % Set justifcation for [one line captions] 
%   {\raggedright}                        %   and {multiple line captions}
%\setlength{\belowcaptionskip}{-10pt}      % Bring caption down closer to figure/table
